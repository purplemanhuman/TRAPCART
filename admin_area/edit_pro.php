...
<body bgcolor= #F0EBDF>
	<form action="" method="post" enctype="multipart/form-data">
		<table align="center" width="795" height = "800" border="2" bgcolor= #EB3E4A>
			<tr align="center">
				<td colspan="6" style="font-family: 'Product Sans'; text-decoration: underline; font-size: 18px; color: #FFFFF8"><h2>Edit and Update Product</h2></td>
			</tr>
			...
			<tr>
				...
				<td><input type="file" name="product_image"><img src="product_images/<?php echo $pro_image;?>"></td>
			</tr>
			...
			<tr>
				...
				<td><input type="text" name="product_keywords" size="50" required="" value = "<?php echo $pro_keywords;?>"></td>
			</tr>
